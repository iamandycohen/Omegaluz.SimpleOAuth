    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Disassociate(string provider, string providerUserId)
        {
            ...
            if (ownerAccount == User.Identity.Name)
            {
                ...
                {
                    bool hasLocalAccount = SimpleOAuthSecurity.HasLocalAccount(WebSecurity.GetUserId(User.Identity.Name));
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : "";
            ViewBag.HasLocalPassword = SimpleOAuthSecurity.HasLocalAccount(WebSecurity.GetUserId(User.Identity.Name));
        ...
        public ActionResult RemoveExternalLogins()
        {
            ...
            ViewBag.ShowRemoveButton = externalLogins.Count > 1 || SimpleOAuthSecurity.HasLocalAccount(WebSecurity.GetUserId(User.Identity.Name));
