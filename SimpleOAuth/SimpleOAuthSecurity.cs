...
namespace Omegaluz.SimpleOAuth
{
    ...
    /// </summary>
    public static class SimpleOAuthSecurity
    {
        internal static OAuthMembershipProvider OAuthDataProvider 
        {
            get
            {
                if (_oAuthDataProvider == null)
                {
                    throw new InvalidOperationException("You must call the SetProvider method first");
                }
        ...
        internal static OAuthMembershipProvider _oAuthDataProvider;
        ...
        public static void SetProvider(OAuthMembershipProvider provider)
        {
            if (provider == null)
            {
        ...
        public static ICollection<OAuthAccount> GetAccountsFromUserName(string userName)
        {
            ...
            return OAuthDataProvider.GetAccountsForUser(userName).Select(p => new OAuthAccount(p.Provider, p.ProviderUserId)).ToList();
        }
